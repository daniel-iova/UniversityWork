...
def menu(polygon_object):
    ...
    while i != 0:
        ...
        if i == 1:
            ...
            polygon_object = test_read()
            input("Press Enter to continue...")
            os.system('cls')
        elif i == 2:
            os.system('cls')
            print("PRINTING FUNCTION")
            test_print(polygon_object)
            input("Press Enter to continue...")
            os.system('cls')
        elif i == 3:
            os.system('cls')
            print("MINIMUM AREA RECTANGLE FUNCTION")
            test_min_rect_area(polygon_object)
            input("Press Enter to continue...")
            os.system('cls')
        elif i == 4:
            os.system('cls')
            print("AREA FUNCTION")
            test_area(polygon_object)
            input("Press Enter to continue...")
            os.system('cls')
        elif i == 5:
            os.system('cls')
            print("PERIMETER FUNCTION")
            test_perimeter(polygon_object)
            input("Press Enter to continue...")
            os.system('cls')
        elif i == 6:
            os.system('cls')
            print("CENTROID FUNCTION")
            test_gravity_center(polygon_object)
            input("Press Enter to continue...")
            os.system('cls')
        elif i == 7:
            os.system('cls')
            print("CONVEXITY CHECK FUNCTION")
            test_convexity(polygon_object)
            input("Press Enter to continue...")
            os.system('cls')
        elif i == 8:
            os.system('cls')
            print("AREA COMPARISON FUNCTION")
            test_area_comparison(polygon_object)
            input("Press Enter to continue...")
            os.system('cls')
        elif i == 9:
            os.system('cls')
            print("POLYGON CONCATENATION FUNCTION")
            test_polygon_concatenation(polygon_object)
            input("Press Enter to continue...")
            os.system('cls')
